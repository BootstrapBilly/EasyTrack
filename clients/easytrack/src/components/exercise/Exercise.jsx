...
const Exercise = ({ name, muscle, backgroundColor, onClick }) => {
    return (
        <div className="flex flex-col font-normal text-sm w-full shadow text-center cursor-pointer" onClick={onClick}>
            <div className="w-full flex items-center justify-center" style={{ backgroundColor }}><img src={require(`../../Assets/exercises/${name}.svg`).default} className="h-20 p-3" alt="exercise_image" /> </div>
